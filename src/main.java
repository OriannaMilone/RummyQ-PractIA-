...
public static void GameLoop(){
        ...
        while(true){
            ...
            //get the color, or the colors and put them into an array
            //check if the colors are valid (red, blue, yellow, black)
            //pair the colors with their code numbers 
            //also, check for exceptions like, empty or integer values
